...
* [WTFilter](https://github.com/kaankilic/wtfilter) - Filter profanity, or other words, out of a string using Laravels localization feature or with any PHP application and some custom coding.
